...
namespace OpenShift.Extension
{
    public static class DapperExtensions
    {
        ...
        public static long InsertOrUpdate<TRes>(this IDbConnection connection, TRes model) where TRes : class
        {
            return connection.InsertOrUpdate(model);
        }
    }
}
